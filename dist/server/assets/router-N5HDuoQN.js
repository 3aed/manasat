...
const appCss = "/assets/styles-B34zWjqR.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "منصات" },
      { name: "description", content: "Manassat Impact Pages builds professional, modern, high-converting landing pages for Saudi NGOs." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "منصات" },
      { property: "og:description", content: "Manassat Impact Pages builds professional, modern, high-converting landing pages for Saudi NGOs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "منصات" },
      { name: "twitter:description", content: "Manassat Impact Pages builds professional, modern, high-converting landing pages for Saudi NGOs." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/0614c5ac-4d26-4644-ad7d-1e926e985966/id-preview-cfe8adec--57c0be04-fc69-4899-9bbd-9a6bfc058a3e.lovable.app-1778147723856.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/0614c5ac-4d26-4644-ad7d-1e926e985966/id-preview-cfe8adec--57c0be04-fc69-4899-9bbd-9a6bfc058a3e.lovable.app-1778147723856.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-DzkCInJc.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "منصات وكالة سعودية متخصصة في تمكين الجمعيات والمنظمات غير الربحية عبر قياس الأثر، برمجة المنصات الرقمية، وتصاميم السوشيال ميديا الاحترافية."
    }, {
      property: "og:title",
      content: "منصات | شريككم الاستراتيجي للقطاع غير الربحي"
    }, {
      property: "og:description",
      content: "نُمكّن الجمعيات السعودية من توسيع أثرها عبر حلول رقمية متوافقة مع رؤية 2030."
    }, {
      property: "og:type",
      content: "website"
    }],
    links: [{
      rel: "preload",
      href: "/fonts/handicrafts-regular.woff2",
      as: "font",
      type: "font/woff2",
      crossOrigin: ""
    }, {
      rel: "preload",
      href: "/fonts/handicrafts-bold.woff2",
      as: "font",
      type: "font/woff2",
      crossOrigin: ""
    }]
